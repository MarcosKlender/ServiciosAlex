...
<label class="text-gray-700">Stock {{ $stocks->stock1_name }}</label>
...
<label class="text-gray-700">Stock {{ $stocks->stock2_name }}</label>
...
<label class="text-gray-700">Stock {{ $stocks->stock3_name }}</label>
...
<label class="text-gray-700">Stock {{ $stocks->stock4_name }}</label>
...
<label class="text-gray-700">Stock {{ $stocks->stock5_name }}</label>
...
<label class="text-gray-700">Stock {{ $stocks->stock6_name }}</label>
